...
<html>
	...
	<body>
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td height="22" valign="top" class="word_orange">
					<img src="/ssh_gdzc_sys/images/7.gif" width="33" height="33">
				...
				<td height="22" valign="top" class="word_orange">
					<table width="100%" border="0">
						<tr>
							...
							<td width="8%">
								<label>
									<img src="/ssh_gdzc_sys/images/jiaodian_biao.gif" width="21"
										height="17">
       ...
       <form name="PageForm" action="/ssh_gdzc_sys/servlet/ZcwxContactServlet" method="post">
