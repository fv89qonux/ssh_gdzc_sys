      ...
      <tr>
        <td><table width="98%" border="0" align="center" class="bgcontain" id="menu">
          <tr>
            ...
            <td width="5%"><a href="/ssh_gdzc_sys/zc_check/checkzc.jsp" target="main">资产查询</a></td>
            
            <td width="5%"><a href="../lendInfos.do" target="main" target="main">借还管理</a></td>
            
            <td width="5%"><a href="/ssh_gdzc_sys/zc_inout/zcInOutCheck.jsp" target="main">借还查询</a></td>
            
            <td width="5%"><a href="../assetPerAction.do"  target="main">维修管理</a></td>
            
            <td width="5%"><a href="/ssh_gdzc_sys/zc_wx/checkZcwxInfo.jsp" target="main">维修查询</a></td>
            
            <td width="5%"><a href="/ssh_gdzc_sys/employeeAction.do" target="main">员工管理</a></td>
            
            <td width="5%"><a href="../printStoreIn.do" target="main">打印报表</a></td>
            
			<c:if test="${sessionScope.competence == '管理员' }">
            <td width="5%"><a href="/ssh_gdzc_sys/userManaAction.do"target="main">用户管理</a></td>
            </c:if>
            
            <td width="5%"><a href="/ssh_gdzc_sys/user_info/updatepwd.jsp" target="main">修改密码</a></td>
