  ...
  <table width="80%" border="0" align="center">
    <tr>
      <td><table width="98%" border="0" align="center" class="tableBorder">
        <tr>
          <td><img src="/ssh_gdzc_sys/images/11.gif" width="46" height="33"><span class="word_orange2"><strong>系统用户信息</strong></span></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><table width="100%" border="0">
            <tr>
              ...
              <td width="17%">&nbsp;</td>
              <td width="11%">
              <img src="/ssh_gdzc_sys/images/jiaodian_biao.gif" width="21" height="17">
              <input name="addUser" type="button" class="button" id="addUser" value="添加用户"
              onclick="window.location='/ssh_gdzc_sys/user_info/user_add.jsp'"></td>
            </tr>
