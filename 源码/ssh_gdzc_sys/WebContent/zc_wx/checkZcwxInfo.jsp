			...
			<tr>
				<td>
					<table width="98%" border="0" align="center">
						<tr>
							<td>
								<img src="/ssh_gdzc_sys/images/9.gif" width="36" height="30">
									...
									<table width="100%" border="0" bgcolor="#E3F4F7"
										...
										<tr>
											<td width="14%" height="36">
												<img src="/ssh_gdzc_sys/images/Favorites.gif" width="16" height="16">
												维修流水号：
											</td>
											<td width="28%">
												<label>
                  ...
                  readonly="true"  size="25" maxlength="30"/>
						...
						<tr>
							<td>
								<img src="/ssh_gdzc_sys/images/10.gif" width="37" height="34">
